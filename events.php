...
<head>
	...
	<meta name="description" content="Check our mega parties!">
...
<section id="page-header">
	<div class="container clearfix">
		<hgroup>
			...
			<h2 class="page-subtitle">REX 2013</h2>
		</hgroup>
		<!-- share it -->
		<div id="share-wrap">
...
<section id="main-content" class="container events">
	<h4 class="events-heading">All Week <span class="color"></span></h4>
	<!-- events list -->
	<!-- events list -->
	...
	<h4 class="events-heading">Saturday <span class="color"></span></h4>
	<!-- events list -->
	<ul class="none events-list">
		<!-- event -->
		<li>
	...
	<h4 class="events-heading">Sunday <span class="color"></span></h4>
	<!-- events list -->
	<ul class="none events-list">
		<!-- event -->
		<li>
	...
	<h4 class="events-heading">Monday <span class="color"></span></h4>
	<!-- events list -->
	<ul class="none events-list">
		<!-- event -->
		<li>
	...
	<h4 class="events-heading">Tuesday <span class="color"></span></h4>
	<!-- events list -->
	<ul class="none events-list">
		<!-- event -->
		<li>
	...
	<h4 class="events-heading">Wednesday <span class="color"></span></h4>
	<!-- events list -->
	<ul class="none events-list">
			<!-- event -->
		<li>
	...
	<h4 class="events-heading">Thursday <span class="color"></span></h4>
	<!-- events list -->
	<ul class="none events-list">
			<!-- event -->
		<li>
