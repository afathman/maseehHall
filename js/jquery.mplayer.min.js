...
},whileplaying:function(){p.find(".position").width(p.data("mplayer").position/p.data("mplayer").durationEstimate*100+"%");p.find(".elapsed").php(_formatTime(p.data("mplayer").position));
p.find(".total").php(" / "+_formatTime(p.data("mplayer").durationEstimate));}})).addClass("ready").click(function(i){$this=g(this).data("mplayer");if(e&&e!=$this){e.stop();
